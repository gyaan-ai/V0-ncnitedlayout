...
export function CommitCard({
  ...
  const collegeColors = collegeColorsProp || getSchoolColors(collegeName)
            ...
            <div className="p-4 h-full flex flex-col">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-3">
                <div className="flex items-center gap-4">
                  <div
                    className={cn(
                      "w-20 h-20 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg border-4",
                      collegeColors.bg,
                      collegeColors.border,
                    )}
                  >
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col items-center">
                    <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mb-2 shadow-md border-2 border-red-200">
                  ...
                  {club && (
                    <div className="flex flex-col items-center">
                      <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center mb-2 shadow-md border-2 border-green-200">
