-- COMPLETE ATHLETE COLUMNS MIGRATION
-- This adds ALL missing columns needed for the athlete management system

-- Add commitment and recruiting columns
